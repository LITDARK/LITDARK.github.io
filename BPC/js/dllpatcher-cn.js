...
class PatchContainer {
    ...
    createUI() {
        ...
        for (var i = 0; i < this.patchers.length; i++) {
            ...
            var forceButton = $('<button>').text('强制加载?').hide();
        ...
        label.html("<strong>选择文件</strong> 或直接拖拽至此窗口。");
        ...
        $("<h4>支持版本:</h4>").appendTo(container);
        $("<h5>点击版本号/版本名称以预览可用补丁选项</h5>").appendTo(container);
        ...
        reader.onload = function (e) {
            ...
            for (var i = 0; i < self.patchers.length; i++) {
                ...
                if (patcher.validatePatches()) {
                    ...
                    self.matchSuccessText[i].text(' ' + valid + ' 个选项中的 ' + valid + ' 个选项匹配 (100%) ');
                }
            }
            ...
            if (!found) {
                ...
                for (var i = 0; i < self.patchers.length; i++) {
                    ...
                    self.forceLoadTexts[i].text(' ' + patcher.totalPatches + ' 个选项中的 ' + valid + ' 个选项匹配 (' + percent + '%) ');
